 //gcc create_test_train_dataset.c  -I ../ml-framework/include/  -L ../ml-framework/lib/ -lml-framework -o create_test_train_dataset.out -Wall
//./create_test_train_dataset.out IceCreamSales.csv testing_data.csv training_data.csv 40
...
dimensions_t major_rows;
dimensions_t minor_rows;
dimensions_t shuffled_matrix_rows,shuffled_matrix_columns;
char *dataset_file;
char *test_file;
char *train_file;
int minor_percentage;
//as argument(dataset file,test_file,train_file,minor percentage)
if(argc!=5)
{
...
{
printf("unable to create test\train data files\n");
mlfw_mat_double_destroy(matrix);
return 0;
}
mlfw_mat_double_get_dimensions(shuffled_matrix,&shuffled_matrix_rows,&shuffled_matrix_columns);
minor_rows=(dimensions_t)(minor_percentage*shuffled_matrix_rows)/100;
