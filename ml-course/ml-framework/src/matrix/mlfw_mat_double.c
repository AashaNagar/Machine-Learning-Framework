...
typedef struct __mlfw_mat_double 
{
    double **data;
    dimensions_t rows;
    dimensions_t columns;
} mlfw_mat_double;

mlfw_mat_double * mlfw_mat_double_create_new(dimensions_t rows, dimensions_t columns)
{ 
...
void mlfw_mat_double_get_dimensions(mlfw_mat_double *matrix,dimensions_t *rows,dimensions_t *columns)
{
if(matrix==NULL)return;
if(rows!=NULL)
{
...
void mlfw_mat_double_copy(mlfw_mat_double *target,mlfw_mat_double *source,index_t target_row_index,
index_t target_column_index,index_t source_from_row_index,
index_t source_from_column_index,index_t source_to_row_index,index_t source_to_column_index)
{
