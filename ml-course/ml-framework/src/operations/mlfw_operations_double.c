...
{
dimensions_t left_matrix_rows;
dimensions_t left_matrix_columns;

dimensions_t right_vector_size;
...
mlfw_column_vec_double * mlfw_multiply_double_row_vector_with_column_vector(mlfw_row_vec_double * left_vector,
mlfw_column_vec_double * right_vector)
{
mlfw_column_vec_double *product_vector;
double product;	
index_t i;
dimensions_t left_vector_size;
dimensions_t right_vector_size;
